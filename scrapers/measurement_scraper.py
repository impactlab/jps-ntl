...
for meter in meters:    
  ...
  for header_row in header_table.find_all('tr'):
    ...
    if first_time_through: columns.append(header_cols[0].text.strip())
    values[-1].append(header_cols[1].text.strip())
  ...
  for main_row in main_table.find_all('tr'):
    ...
    if first_time_through: columns.append(main_cols[0].text.strip())
    values[-1].append(main_cols[1].text.strip())
